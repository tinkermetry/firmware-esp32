...
{
    ESP_LOGD(TAG, "Starting I2C slave at port %d.", i2c_slave_config->port);
    ...
    ESP_ERROR_CHECK(i2c_param_config(i2c_slave_config->port, &esp32_i2c_config));
    ESP_ERROR_CHECK(i2c_driver_install(
        i2c_slave_config->port,
